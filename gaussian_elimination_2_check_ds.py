...
revision 2.00 03/11/14  included check solution code
                        changed filename, commented out tests [ds]
...
aug_3 = [[ 10.0, 10.0   , 10.0   , 10.0e17, 10.0e17],
         [ 1.0 , 10.0e-3, 10.0e-3, 10.0e-3, 1.0    ],
         [ 1.0 ,  1.0   , 10.0e-3, 10.0e-3, 2.0    ],
         [ 1.0 ,  1.0   , 1.0    , 10.0e-3, 3.0    ]]

aug_4 = [[ 1.0 ,  1.0   , 1.0    , 10.0e-3, 3.0    ],
         [ 1.0 , 10.0e-3, 10.0e-3, 10.0e-3, 1.0    ],
         [ 1.0 ,  1.0   , 10.0e-3, 10.0e-3, 2.0    ],
         [ 10.0, 10.0   , 10.0   , 10.0e17, 10.0e17]]
